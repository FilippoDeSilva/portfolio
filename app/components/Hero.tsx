  ...
  return (
    <>
      ...
      >
        ...
        {showBounce && (
          <motion.div
            initial={{ y: 15 }} // Default for larger screens
            animate={{ y: [15, 10, 15] }} // Bounce animation for larger screens
            transition={{ duration: 1.5, repeat: Infinity, repeatType: "loop" }}
            className="absolute bottom-20 sm:bottom-[10px] left-[47%] transform -translate-x-1/2 lg:bottom-20 lg:left-[47%]" // Centering horizontally and vertically adjusting for small screens
            onClick={() =>
              document
